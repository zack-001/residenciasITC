...
export function ReporteFinal(props){
  ...
  <Document>
      <Page size="LETTER" >
        ...
        <View style={{textAlign:'right', fontSize:11, marginTop:'25px', marginRight:'2cm'}}>
          <Text style={{ fontFamily:'Times-Roman'}}>ASUNTO: <Text style={{ fontFamily:'Times-Bold'}}>REPORTE FINAL DE RESIDENCIA PROFESIONAL</Text></Text>              
        ...
        <Text>{props.personal && props.personal[1]}</Text>
          <Text>JEFE DEL DEPTO. DE C.E.A</Text>
          <Text>PRESENTE:</Text>
        </View>
        
      <View style={styles.body}>
          <Text style={{fontFamily:'Times-Roman', fontSize:11}}>
          Por este conducto como asesor del <Text style={{fontFamily:'Times-Bold'}}>REPORTE FINAL DE RESIDENCIA PROFESIONAL PARA TITULACIÓN INTEGRAL</Text>, que lleva por título: <Text style={{fontFamily:'Times-Bold'}}>{props.data.nombre}</Text>,
           que presenta el(los) alumno(s) <Text style={{fontFamily:'Times-Bold'}}>{alumnos}</Text>, de la carrera de <Text style={{fontFamily:'Times-Bold'}}>{carrera}</Text>; después de haber revisado y analizado nos permitimos autorizarlo, para que continúe con los trámites correspondientes.
          
          </Text>
       </View>   
      <View style={{ fontSize:11, textAlign:'center', marginTop:'1cm'}}>
        <Text style={{ fontFamily:'Times-Bold'}} >A T E N T A M E N T E</Text>
