...
export function AsignacionRevisor(props){
  ...
  <Document>
      <Page size="LETTER" >
        ...
        <View style={styles.asunto}>
          ...
          <Text>ASUNTO: <Text style={{ fontFamily:'Times-Bold' }}>Asignación de Revisor para Reporte final</Text></Text>              
        ...
        <View style={styles.body}>
          <Text>Por este conducto solicito a usted tenga a bien revisar el Reporte Final de Residencia Profesional que se acompaña, 
              emitiendo su aprobación o bien, señalando las observaciones que considere pertinentes para mejorar la calidad del mismo.
            Asimismo, le informo que tiene 5 días hábiles para revisar y reportar a este depto. </Text>       
        </View>
